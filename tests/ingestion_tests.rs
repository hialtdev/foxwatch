...
fn test_extract_device_id_edge_cases() {
    // 1. Standard HA topic
    assert_eq!(extract_device_id("homeassistant/light/bulb_01/state"), Some("bulb_01".to_string()));
    ...
    assert_eq!(extract_device_id("homeassistant/status"), Some("status".to_string()));
...
fn test_extract_device_id_suite() {
    ...
    assert_eq!(extract_device_id("homeassistant/binary_sensor/attic_motion/state"), Some("attic_motion".to_string()));
